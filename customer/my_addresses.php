...
<input type="submit" name="update_billing_address" value="Update Billing Address" class="btn btn-success form-control" >
...
<input type="submit" name="update_shipping_address" value="Update Shipping Address" class="btn btn-success form-control" >
